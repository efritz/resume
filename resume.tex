...
\begin{entrylist}
  ...
  \entry
    ...
    {
      \bulletpoint{GPA}{TBA/4.0} \\
      \bulletpoint{Advisor}{Dr. John Boyland} \\
      \bulletpoint{Dissertation Title}{`TBA'}
      \bulletpoint{Awards}{CEAS Dean's Scholarship, Spring 2014}
    }
  ...
  \entry
    ...
    {University of Wisconsin - Milwaukee}
    {
      \bulletpoint{GPA}{3.970/4.0} \\
      \bulletpoint{Advisor}{Dr. Christine Cheng} \\
      \bulletpoint{Capstone Title}{`Optimizing Distance Cache for RedPrairie Plan Optimizer'} \\
      \bulletpoint{Awards}{Chancellor's Graduate Student Awards (CGSA), Spring 2013} \\
      \bulletpoint{Awards}{CEAS Dean's Scholarship, Fall 2013}
    }
